        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
          ...
          <div className="w-full md:w-auto flex flex-col items-center md:items-start">
            ...
            <div className="flex gap-3 w-full max-w-xs">
              ...
              <a 
                href="https://github.com/angstremoff/domgomobile/releases/latest/download/DomGo.apk" 
                download="DomGo.apk"
                ...
                onClick={(e) => {
                  e.preventDefault();
                  window.location.href = 'https://github.com/angstremoff/domgomobile/releases/latest/download/DomGo.apk';
                }}
              >
