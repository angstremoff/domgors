                  ...
                  <div className="flex flex-col lg:flex-row gap-3 sm:gap-6">
                    ...
                    <div className="lg:w-1/2">
                      ...
                      <div className="mb-3 sm:mb-6">
                        <div className="bg-[#1E3A8A] text-white p-2 sm:p-3 rounded-t-lg sm:rounded-t-xl flex items-center">
                          <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 11-6 0 3 3 0 016 0z" />
                          </svg>
                        ...
                        <div className="bg-white rounded-b-lg sm:rounded-b-xl p-2 sm:p-3 border border-gray-100 shadow-sm">
                          <div className="flex gap-3 justify-center items-center">
                            ...
                            >
                              <svg className="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M21.226 17.348a.295.295 0 0 1-.231.376l-.802.16a12.44 12.44 0 0 1-2.203.2C11.22 18.118 6 13.023 6 6.315a11.08 11.08 0 0 1 .062-1.167l.056-.673a.306.306 0 0 1 .282-.282L8.1 4.03a.32.32 0 0 1 .347.2l1.114 2.592a.31.31 0 0 1-.113.38L7.33 8.388a.626.626 0 0 0-.226.615c.5 2.287 2.273 4.106 4.585 4.637.282.065.549-.063.717-.269l1.384-1.69a.314.314 0 0 1 .378-.086l2.56 1.136a.332.332 0 0 1 .18.355l-.682 4.062z"/>
                                <path d="M13.5 1.5C7.159 1.5 2 6.12 2 12c0 5.881 5.159 10.5 11.5 10.5S25 17.88 25 12c0-5.881-5.159-10.5-11.5-10.5zm0 19C7.71 20.5 3 16.694 3 12 3 7.306 7.71 3.5 13.5 3.5S24 7.306 24 12c0 4.694-4.71 8.5-10.5 8.5z"/>
                              </svg>
                            </a>
                          </div>
                        </div>
