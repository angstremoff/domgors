                        ...
                        <div className="bg-white rounded-b-lg sm:rounded-b-xl p-2 sm:p-3 border border-gray-100 shadow-sm">
                          <div className="flex gap-2 items-center">
                            <button
                              ...
                              className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-100 text-[#1E3A8A] hover:bg-indigo-200 transition-colors"
                            >
                              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 5H6a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2v-1M8 5a2 2 0 002 2h2a2 2 0 002-2M8 5a2 2 0 012-2h2a2 2 0 012 2m0 0h2a2 2 0 012 2v3m2 4H10m0 0l3-3m-3 3l3 3" />
                              </svg>
                              <span className="text-sm font-medium">{isCopied ? t('common.copied') : t('common.copyLink')}</span>
                            </button>
                            ...
                            <a
                              ...
                              className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-100 text-[#0088cc] hover:bg-blue-200 transition-colors"
                            ...
                            >
                              ...
                              <span className="text-sm font-medium">{t('common.shareViaTelegram')}</span>
                            </a>
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-green-100 text-[#25D366] hover:bg-green-200 transition-colors"
                            ...
                            >
                              ...
                              <span className="text-sm font-medium">{t('common.shareViaWhatsApp')}</span>
                            </a>
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-purple-100 text-[#7360f2] hover:bg-purple-200 transition-colors"
                            ...
                            >
                              ...
                              <span className="text-sm font-medium">{t('common.shareViaViber')}</span>
                            </a>
                          </div>
                        </div>
                      </div>
