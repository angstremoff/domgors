                      ...
                      <div className="mb-3 sm:mb-6">
                        ...
                        <div className="bg-white rounded-b-lg sm:rounded-b-xl p-2 sm:p-3 border border-gray-100 shadow-sm">
                          <div className="flex gap-3 justify-center items-center">
                            ...
                            >
                              <svg className="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M12.6.6C5.9.6.5 5.7.5 12c0 6 5.1 11.2 11.9 11.5 6.8.3 12.2-5 12.2-11.5 0-6.4-5.3-11.4-12-11.4zm4 15.3c-.2.3-.8.7-1.7.7h-.3c-2.4-.1-4.5-1-6.2-2.5-1.6-1.4-2.8-3.3-3.4-5.4-.3-1.8 0-3.3 1.2-4.3.3-.3.6-.4 1-.4h.3c.6 0 .9.1 1.2.8.3.8.9 2.9.9 3.1.1.5-.2 1-.5 1.3-.1.1-.3.3-.2.4.4.7 1 1.3 1.6 1.8.7.5 1.4.8 2.2 1.1h.2c.3 0 .5-.4.7-.7.3-.5.5-.6 1.1-.4 1.4.6 1.9.9 2 1 .3.3.3.8.1 1.2zm.5-8.5c-.1-.1-.3-.2-.4-.2-1.8-.5-3.5-.7-5.5-.6h-.6c-.3.1-.4.3-.4.5 0 .3.1.5.3.5.7.3 2 .4 2.5.5 2.3.5 3.9 1.7 4.8 3.7.2.4.2.8.2 1.3 0 .2.2.4.5.4h.1c.3 0 .5-.3.5-.5.5-2.1.2-3.6-.9-5-.2-.2-.5-.5-1.1-.6zm-4-3c.8 0 1.6.1 2.4.3.3.1.7.2 1.1.3.3.1.4.4.4.6 0 .3-.2.5-.5.5h-.2c-.8-.3-1.7-.3-2.5-.3-4 0-7.2 3.3-7.2 7.4 0 .5 0 .9.1 1.4v.4c0 .3.2.5.4.5h.1c.3 0 .5-.2.5-.5v-1.2c-.1-3.7 2.3-6.8 5.9-6.8.2-.4-.3-.6-.5-.6z" />
                              </svg>
                            </a>
                          </div>
                        </div>
