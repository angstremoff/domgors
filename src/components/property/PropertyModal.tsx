                  ...
                  <div className="lg:w-1/2">
                    ...
                    <div className="mb-4 space-y-3">
                      <div className="flex items-start justify-between flex-col sm:flex-row">
                        ...
                        <div className="text-lg font-bold text-[#1E3A8A] mt-2 sm:mt-0">
                    ...
                    <div className="mb-4 grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {property.property_type !== 'land' && (
                        <div className="p-3 bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                      ...
                      <div className="mb-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                          {property.features.includes('elevator') && (
                            <div className="p-2.5 bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow flex items-center gap-3">
